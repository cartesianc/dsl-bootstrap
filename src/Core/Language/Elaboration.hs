...
defaultElaborationContract =
  ElaborationContract
    { elaborationBindings =
        ...
        , elaborator LowerToCurrentAst "AST.AppBlueprint.blueprint" AppBlueprintSyntax
        ...
        , elaborator LowerToProfile "Effects.EffectTheory.profile" EffectSectionSyntax
        , elaborator LowerToImplement "Effects.EffectTheory.implement" ImplementationBindingSyntax
        , elaborator LowerToHanging "Blueprint.hanging" HangingBlockSyntax
        , elaborator LowerToChain "Blueprint.chain" WorkflowComponentSyntax
        , elaborator LowerToParallel "Blueprint.parallel" WorkflowComponentSyntax
        , elaborator LowerToWorkflowFact "Blueprint.fact" WorkflowComponentSyntax
        , elaborator LowerToAllOf "Blueprint.allOf" FactExprSyntax
        , elaborator LowerToAnyOf "Blueprint.anyOf" FactExprSyntax
        , elaborator LowerToWait "Blueprint.wait" WorkflowComponentSyntax
        , elaborator LowerToFallback "Blueprint.fallback" WorkflowComponentSyntax
        , elaborator LowerToRace "Blueprint.race" WorkflowComponentSyntax
        , elaborator LowerToChoice "Blueprint.choice" WorkflowComponentSyntax
        , elaborator LowerToChoiceBranch "Core.Architecture.choiceBranch" ChoiceBranchSyntax
        , elaborator LowerToMiddleware "Blueprint.middleware" HangingComponentSyntax
        , elaborator LowerToCallback "Blueprint.callback" HangingComponentSyntax
        , elaborator LowerToSuspense "Blueprint.suspense" HangingComponentSyntax
        , elaborator LowerToLoop "Blueprint.loop" HangingComponentSyntax
        ]
    }

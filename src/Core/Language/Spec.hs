  ...
  LanguageSpec
    { languageKeywords =
        ...
        , keyword "app"
            [ required "ast" AppBlueprintSyntax
            , required "effects" EffectTheorySyntax
            , optional "profile" ProfileNameSyntax
            ]
            AppPlanSyntax
            [RootSyntax]
            LowerToAppBuild
        ...
        , keyword "externalTake"
            ...
            LowerToExternalTake
        , keyword "profile"
            [ required "profile" ProfileNameSyntax
            , many "implementations" ImplementationBindingSyntax
            ]
            EffectSectionSyntax
            [EffectUnitSyntax]
            LowerToProfile
        , keyword "implement"
            [ required "send" SendNameSyntax
            , required "handler" ImplementationNameSyntax
            ]
            ImplementationBindingSyntax
            [EffectSectionSyntax]
            LowerToImplement

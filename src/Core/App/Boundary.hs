...
checkMinimalCore blueprint effects currentProfile =
  buildMinimalCoreReport <$> app blueprint effects currentProfile

checkMinimalCoreModel ::
  AppModel ->
  ProfileName ->
  Either AppError MinimalCoreReport
checkMinimalCoreModel currentModel currentProfile =
  hyloAppModel
    (\blueprint effects -> checkMinimalCore blueprint effects currentProfile)
    currentModel
